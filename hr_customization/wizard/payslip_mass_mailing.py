...
class PayslipMassMailing(models.TransientModel):
        ...
        for id_vals in ids:
            ...
            if payslip_browse.state == 'done':
                if payslip_browse.employee_id.work_email:
                    try:
                        template_id = ir_model_data._xmlid_to_res_id('hr_customization.email_template_hr_payslip')
                    except ValueError:
                        template_id = False
