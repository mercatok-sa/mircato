...
class HrCustody(models.Model):
    ...
    purpose = fields.Char(string='Reason', required=True, readonly=True, help="Reason",
                          states={'draft': [('readonly', False)]})
    custody_name = fields.Many2one('custody.property', string='Property', required=True, readonly=True,
                                   help="Property name",
                                   states={'draft': [('readonly', False)]})
    return_date = fields.Date(string='Return Date', required=True, readonly=True,
                              help="Return date",
                              states={'draft': [('readonly', False)]})
    renew_date = fields.Date(string='Renewal Return Date', help="Return date for the renewal", readonly=True, copy=False)
